{* $Id: mod-login_box.tpl 51775 2014-06-29 18:49:04Z lphuberdeau $ *}
{jq notonready=true}
...
{tikimodule error=$module_params.error title=$tpl_module_title name="login_box" flip=$module_params.flip decorations=$module_params.decorations nobox=$module_params.nobox notitle=$module_params.notitle style=$module_params.style}
	...
	{if $user}
		...
		{elseif $mode eq "navbar"}
			 <div class="navbar-collapse collapse in">
			 <ul class="nav navbar-nav">
			  <li><a href="tiki-logout.php" class="dropdown-toggle login_link" data-toggle="dropdown">
					{tr}Log out{/tr}
					<span class="caret"></span>
				</a>
	...
	{else}
		...
		{else if $mode eq "navbar"}
			<div class="siteloginbar_dropdown navbar-right navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="dropdown">
			...
			{capture assign="close_tags"}</div></div></li>{$close_tags}{/capture} 
		{/if}
