<article class="article">
	...
	<div class="articleheading">
				...
				{if $topicId}
					<a href="tiki-view_articles.php?topic={$topicId}" class="thumbnail{if $big_image} cboxElement{/if}{if $isfloat eq 'y'} pull-left{/if}" title="{if $show_image_caption and $image_caption}{$image_caption|escape}{else}{tr}List all articles of this same topic:{/tr} {tr}{$topicName|escape}{/tr}{/if}">
				{/if}
